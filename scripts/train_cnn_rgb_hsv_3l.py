...
from src.preprocessing import rgb_to_hsv
...
output_dir='/home/pb929/Projects/Malaria_Classification/models/cnn_rgb_hsv_3l'

train_gen, val_gen, (test_gen, test_filenames) = load_with_imagedatagenerator(data_dir, augment=True, preprocessing_fn=rgb_to_hsv)
