...
output_dir='/home/pb929/Projects/Malaria_Classification/models/cnn_rgb_hsv_dual_3l_lr_0.0001'
...
train_and_save(model, train_gen, val_gen, test_gen, test_filenames, output_dir, learning_rate=0.0001, use_EarlyStopping=True, use_ReduceLROnPlateau=False, 
